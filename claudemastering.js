...
let fxCtx2 = null, fxSource2 = null, fxChain2 = null;
...
function clearFX2() {
  ...
  fxCtx2 = fxSource2 = fxChain2 = null;
  fxIsPlaying2 = false;
  fxStartTime2 = 0;
  fxDuration2 = 0;
...
function makeRealtimeFXChain(buffer, params) {
  ...
  if (params.noiseReduction && params.noiseReduction > 0) {
    noiseGate = fxCtx2.createDynamicsCompressor();
    noiseGate.threshold.value = -60 + (params.noiseReduction * 30);
    noiseGate.ratio.value = 8;
    noiseGate.attack.value = 0.005;
    noiseGate.release.value = 0.1;
  }
